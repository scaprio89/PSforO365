...
$Results | Select Name,SamAccountName,Email,UserPrincipalName,Department,MailboxSize,MailboxItemCount,RecipientTypeDetails,IssueWarningQuota,ProhibitSendQuota,ProhibitSendReceiveQuota,Database | Export-Csv .\MailboxSizeByDepartment.csv -NoTypeInformation 
